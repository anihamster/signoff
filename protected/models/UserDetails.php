...
class UserDetails extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('USER_ID, BRAND, ROLE_ID, KEY_USER, CAN_ADD', 'numerical', 'integerOnly'=>true),
			...
			array('ID, USER_ID, ROLE_ID, BRAND, PHONE, EMAIL, NAME, SURNAME, KEY_USER, CAN_ADD', 'safe', 'on'=>'search'),
		);
	}
